...
export default function OrdenesPago({ usuario, onNavegar, onLogout }) {
  const pedidosIniciales = [
    { codigo: "ODP_004", estado: "Aprobado", fecha: "2026-04-05" },
    { codigo: "ODP_003", estado: "En Proceso", fecha: "2025-03-21" },
    { codigo: "ODP_002", estado: "Pendiente", fecha: "2026-01-30" },
    { codigo: "ODP_001", estado: "Aprobado", fecha: "2025-12-28" }
  ];
