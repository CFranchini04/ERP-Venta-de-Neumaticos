...
export default function NuevaFactura({ usuario, onNavegar, onLogout }) {
  ...
  const handleGenerarFactura = async () => {
    try {
      ...
      // Generar número de factura con formato consistente: FC-V-{presupuesto_id con 4 dígitos}
      // Para futuro: usar un contador secuencial en la BD
      const numeroFactura = `FC-V-${String(presupuesto.id_presupuesto).padStart(4, "0")}`;

      // Filtrar detalles válidos y asegurar que tengan todos los campos requeridos
      ...
      // Redirigir a facturas o a detalle de la factura creada
