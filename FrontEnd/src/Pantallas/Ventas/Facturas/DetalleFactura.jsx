...
export default function DetalleFactura({ usuario, onNavegar, onLogout }) {
  ...
  const clienteCI = factura?.clientes?.personas?.ruc || "-";
  ...
  return (
    <div style={styles.pagina}>
      ...
      <main style={styles.contenido}>
        ...
        {loading && <div>Cargando factura...</div>}
              ...
              <div style={styles.card}>
                ...
                <div style={styles.datosFila}>
                  ...
                  <div style={styles.datoGrupo}>
                    ...
                    <p style={styles.datoValor}>{clienteCI}</p>
                  </div>
                </div>
              </div>
