...
export function IconoFacturaCancel(){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
export function IconoLibro(){
  return(
   <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 256 256">
    <path fill="currentColor" d="M208 26H72a30 30 0 0 0-30 30v168a6 6 0 0 0 6 6h144a6 6 0 0 0 0-12H54v-2a18 18 0 0 1 18-18h136a6 6 0 0 0 6-6V32a6 6 0 0 0-6-6m-90 12h52v78l-22.41-16.8a6 6 0 0 0-7.2 0L118 116Zm84 148H72a29.87 29.87 0 0 0-18 6V56a18 18 0 0 1 18-18h34v90a6 6 0 0 0 9.6 4.8l28.4-21.3l28.41 21.3A6 6 0 0 0 182 128V38h20Z">
      </path>
    </svg>
  );
}
...
export function IconoCuentas(){
  return(
   <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24">
    <g fill="none"><path d="M9.708 2.5a2.5 2.5 0 0 1 4.584 0H20.5v19h-17v-19z" clipRule="evenodd"></path>
    <path stroke="currentColor" strokeLinecap="square" strokeWidth={2} d="M9.708 2.5a2.5 2.5 0 0 1 4.584 0H20.5v19h-17v-19z" clipRule="evenodd"></path>
    <path stroke="currentColor" strokeLinecap="square" strokeWidth={2} d="M8 8h8m-8 4h8m-8 4h5">
      </path>
    </g>
  </svg>
  );
...
export function IconoSumas(){
  return(
   <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24">
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 5H3m8 7H3m13 7H3M18 9v6m3-3h-6">
      </path>
    </svg>
  );
}

export function IconoResultados(){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24">
      <path fill="currentColor" d="M8 3H6v3H3v2h3v3h2V8h3V6H8zm5 3h8v2h-8zm0 8h8v2h-8zm0 4h8v2h-8zm-3.46-4.96L7 15.59l-2.54-2.55l-1.42 1.42L5.59 17l-2.55 2.54l1.42 1.42L7 18.41l2.54 2.55l1.42-1.42L8.41 17l2.55-2.54z">
        </path>
    </svg>
  );
}

export function IconoMovimiento(){
  return(
...
export function IconoCerrar() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20">
	    <path fill="currentColor" d="M2.93 17.07A10 10 0 1 1 17.07 2.93A10 10 0 0 1 2.93 17.07M11.4 10l2.83-2.83l-1.41-1.41L10 8.59L7.17 5.76L5.76 7.17L8.59 10l-2.83 2.83l1.41 1.41L10 11.41l2.83 2.83l1.41-1.41L11.41 10z"></path>
    </svg>
  );
}
